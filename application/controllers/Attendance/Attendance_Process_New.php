            ...
            for ($x = 0; $x < count($dtEmp['EmpData']); $x++) {
                ...
                if ($FromDate <= $ToDate) {
                    ...
                    if ($shift_type == "DU") {
                        ...
                        $leave_type = 0;
                        // Get the CheckIN
                        $dt_in_Records['dt_Records'] = $this->Db_model->getfilteredData("select min(AttTime) as INTime,Enroll_No,AttDate from tbl_u_attendancedata where Enroll_No = '$EmpNo' and AttDate='" . $FromDate . "' AND AttTime BETWEEN '03:00:00' AND '15:00:00' ");
