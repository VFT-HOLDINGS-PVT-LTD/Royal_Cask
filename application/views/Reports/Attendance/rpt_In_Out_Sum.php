            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black; width:55px;">LATE(M)</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:55px;">OT(H:M)</th>   
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;width:55px;">' . $data->LateM . '</td>
                        <td style="font-size:10px;width:55px;">' . $hours . ':' . $min . '</td>
