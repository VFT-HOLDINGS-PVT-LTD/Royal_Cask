                    ...
                    <ul class="acc-menu">
                        ...
                        <?php if ($currentUser[0]->master_data == 1): ?>
                            ...
                            <?php if ($currentUser[0]->master_data == 1): ?>
                                ...
                                <!-- <?php if ($currentUser[0]->weekly_roster == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Master/Weekly_Roster2/">MONTHLY ROSTER PATTERN</a></li>
                                <?php endif; ?> -->

                                <!-- <?php if ($currentUser[0]->weekly_roster == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Master/Weekly_Roster_Excel/">WEEKLY ROSTER EXCELL</a></li>
                                <?php endif; ?> -->
