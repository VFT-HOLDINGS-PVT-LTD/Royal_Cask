...
<head>
    <!-- Styles -->
    <?php if (isset($this)) { $this->load->view('template/css.php'); } ?>
...
<body class="infobar-offcanvas">
    ...
    <?php if (isset($this)) { $this->load->view('template/header.php'); } ?>
    ...
    <div id="wrapper">
        <div id="layout-static">
            ...
            <?php if (isset($this)) { $this->load->view('template/dashboard_side.php'); } ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <!-- insert permissions to new user from this modal -->
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <h2 class="modal-title">
                                                                                Insert Permissions for User Level:
                                                                                <span id="user_level_display_alt"
                                                                                    style="color: #337ab7;"></span>
                                                                            </h2>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                        <form id="insert_permissions" action="<?= base_url('Master/User_Levels/insert_permission_data') ?>" method="POST">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="row" style="margin-top: 10px;">
                                                                                    ...
                                                                                    $columns = 4;
                                                                                    foreach (array_chunk($permissions, ceil(count($permissions) / $columns)) as $column) {
                                                                                        echo '<div class="col-md-3">';
                                                                                        foreach ($column as $perm) {
                                                                                            echo '<label><input type="checkbox" name="permissions[]" value="' . $perm . '"> ' . ucfirst(str_replace('_', ' ', $perm)) . '</label><br>';
                                                                                        }
                                                                                        echo '</div>';
                                                                                    }
                                                                                    ?>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" class="btn btn-success" id="saveLater">Save Later</button>
                                                                            </div>
                                                                        </form>
                                        ...
                                        <div class="col-md-12">
                                            <div class="panel panel-primary">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body panel-no-padding">
                                                        <form class="form-horizontal" id="frm_user_level_view"
                                                            name="frm_user_level_view"
                                                            action="<?php echo base_url(); ?>Master/User_Levels/update_permission_data"
                                                            method="POST" style="margin-top: 20px;">
                                                            <div class="form-group col-sm-12"
                                                                style="display: flex; align-items: center;">
                                                                <label for="user_level_select"
                                                                    class="col-sm-4 control-label"
                                                                    style="text-align: right;">Select User Level</label>
                                                                <div class="col-sm-6 input-group"
                                                                    style="margin-left: 10px;">
                                                                    <select class="form-control" id="user_level_select"
                                                                        name="user_level_select" required>
                                                                        <option value="">-- Select User Level --
                                                                        </option>
                                                                        <?php foreach ($data_set as $data): ?>
                                                                        <option
                                                                            value="<?php echo $data->user_level_id; ?>">
                                                            ...
                                                            <input type="hidden" name="user_level_id"
                                                                id="user_level_id_input">

                                                            <div class="form-group col-sm-10">
                                                                <div class="col-md-12 text-end">
                                                                <div class="permissions-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                                                                    <label for="permissions_checklist" style="font-weight: bold;">Permissions Checklist</label>
                                                                                    <div>
                                                                                        <button type="button" id="markAll" class="btn btn-success btn-sm" style="margin-right: 5px;">Mark All</button>
                                                                                        <button type="button" id="unmarkAll" class="btn btn-danger btn-sm">Unmark All</button>
                                                                                    </div>
                                                                                </div>
        ...
        <?php if (isset($this)) { $this->load->view('template/js.php'); } ?> <!-- Initialize scripts for this page-->


        <!-- End loading page level scripts-->

        <!-- scripts for user level insert modal ui -->
        <script>
            // Save Later button functionality
            document.getElementById('saveLater').addEventListener('click', function () {
                alert('Your progress has been saved. You can complete it later.');
                setTimeout(function () {
                    $('#newModal').modal('hide');
                }, 500);
            ...
            // Unmark All button functionality
        ...
        <!-- Ajax for insert user level -->
        <script>
            $(document).ready(function () {
    $('#frm_user_level').off('submit').on('submit', function (e) { // Unbind previous event handlers
        e.preventDefault();
        ...
        var userLevelName = $('#txt_user_level').val();
        var additionalValue = $('#additional_field').length ? $('#additional_field').val() : '';

        $.ajax({
            url: form.attr('action'),
            type: form.attr('method'),
            data: {
                txt_user_level: userLevelName,
            ...
            success: function (response) {
                ...
                if (response.status === 'success') {
                    form.trigger('reset');
                    setTimeout(function () {
                        $('#user_level_display_alt').text(response.user_level);
                        $('#newModal').modal('show');
                    }, 300);
                } else {
        ...
        <!-- ajax for insert permissions -->
        <script>
        $(function () {
            $('#insert_permissions').submit(function (e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status === 'success') {
                            alert('Permissions successfully added!');
                            $('#newModal').modal('hide');
                            $('#insert_permissions')[0].reset();
                            window.location.reload(); // Reload the page to reflect changes
